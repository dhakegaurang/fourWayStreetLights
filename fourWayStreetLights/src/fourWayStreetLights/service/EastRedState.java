...
public class EastRedState implements StreetLightsStateI{
	...
	public EastRedState(StreetLightsContext streetLightsContext, Results resultObj) {		Logger.writeMessage("entering constructor in EastRedState", Logger.setDebugValue(4));
		this.streetLightsContext = streetLightsContext;
		this.resultObj = resultObj;		myState = "EastRedState";
	}
	
	@Override
	public void addVehicle(Vehicle vehicle) {		Logger.writeMessage("entering addVehicle in EastRedState", Logger.setDebugValue(4));
	...
	@Override
	public void moveVehicle(String direction) {		Logger.writeMessage("entering moveVehicle in EastRedState", Logger.setDebugValue(4));		resultObj.storeNewResult("\nState of machine: "+myState);		resultObj.storeNewResult("\nCannot move vehicles since east signal is red");		streetLightsContext.trackAllVehicles();
	}
	
	@Override
	public void toGreenCarPasses(String direction) {		Logger.writeMessage("entering toGreenCarPasses in EastRedState", Logger.setDebugValue(4));
		moveVehicle(direction);
	}
	
	@Override
	public void toRedCarStops(String direction) {		Logger.writeMessage("entering toRedCarStops in EastRedState", Logger.setDebugValue(4));
		resultObj.storeNewResult("\nState of machine: "+myState);		streetLightsContext.trackAllVehicles();
